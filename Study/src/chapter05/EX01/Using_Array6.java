...
public class Using_Array6 {

	public static void main(String[] args) {
		
	    // 배열 선언 방법 (1) = 자료형 뒤에 대괄호
		...
		boolean [] array5 = new boolean[3]; // 기본 값으로 false가 지정된다
		System.out.println(array5[0]);
		
		int [] array6 = new int [3];	// 기본값으로 0이 된다
		System.out.println(array6[0]);
		
		double [] array7 = new double[3]; // 기본값으로 0.0이 된다
